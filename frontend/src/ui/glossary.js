...
const GLOSSARY = {
  ibge_pevs: {
    ...
    terms: [
      ...
      { term: 'val_yearfx_*',          cat: 'Coluna', tag: 'gold',     short: 'Valor da época, sem correção pela inflação. Em reais é o próprio valor da fonte, e em dólar ou euro é convertido pelo câmbio médio do ano. Serve para conferir um ano, e não para comparar anos diferentes.' },
      { term: 'val_real_ipca_*',       cat: 'Coluna', tag: 'gold',     short: 'Valor trazido a reais de hoje pela inflação medida pelo IPCA, o primeiro índice oferecido para valores em reais. O painel abre sem correção, e corrigir é escolha de quem pesquisa. A tabela também guarda versões em dólar e em euro, que convertem pelo câmbio de hoje um valor corrigido pela inflação brasileira, mas o painel não as oferece.' },
      { term: 'val_real_igpm_*',       cat: 'Coluna', tag: 'gold',     short: 'O mesmo valor, corrigido pelo IGP-M da FGV, índice comum em séries de preços no atacado. O IGP-M só começa em 1989, então a coluna fica vazia nos anos anteriores, o que não é defeito. Nesses anos o IPCA cobre a partir de 1980, e o IGP-DI cobre todo o acervo, desde 1974.' },
      { term: 'val_real_cpi_usd',      cat: 'Coluna', tag: 'gold',     short: 'Valor em dólares de hoje pelo poder de compra americano. O valor é convertido pelo câmbio do ano de registro e depois corrigido pelo CPI, o índice de preços ao consumidor dos EUA. É diferente de val_real_ipca_usd, que corrige em reais pelo IPCA e converte pelo câmbio de hoje, e por isso mede o poder de compra brasileiro escrito em dólares. Nas bases de comércio exterior, cujo valor já vem em dólares, esta coluna não passa por câmbio nenhum.' },
      { term: 'val_real_hicp_eur',     cat: 'Coluna', tag: 'gold',     short: 'O equivalente em euros. O valor é convertido pelo câmbio do ano e corrigido pelo HICP, o índice de preços ao consumidor da zona do euro, publicado pelo BCE e pelo Eurostat. Fica vazio antes de 1999, porque o euro ainda não existia.' },
      { term: 'data_quality_flag',     cat: 'Coluna', tag: 'qualidade', short: 'Marca que diz se o sistema conseguiu conferir a linha e o que encontrou. A conferência compara o preço por unidade, que é o valor dividido pela quantidade, com o preço típico do produto. A maioria das linhas fica sem conferência por falta de base, o que não é defeito. Cada marca é explicada na perspectiva Qualidade dos dados. Nesta base também aparece o pico isolado no tempo, um valor grande num único ano que faz a série do estado dar um salto.' },
    ],
  },
  ...
  ibge_pam: {
    ...
    terms: [
      ...
      { term: 'data_quality_flag',     cat: 'Coluna', tag: 'qualidade', short: 'Marca que diz se o sistema conseguiu conferir a linha e o que encontrou. A conferência compara o preço por unidade, que é o valor dividido pela quantidade, com o preço típico do produto. A maioria das linhas fica sem conferência por falta de base, o que não é defeito. Cada marca é explicada na perspectiva Qualidade dos dados. Nesta base também aparecem o pico isolado no tempo, um valor grande num único ano que faz a série do estado dar um salto, e a área inconsistente, quando a área plantada informada é menor que a colhida.' },
    ],
  },
  ...
  ibge_ppm: {
    ...
    terms: [
      ...
      { term: 'data_quality_flag',     cat: 'Coluna', tag: 'qualidade', short: 'Marca que diz se o sistema conseguiu conferir a linha e o que encontrou. A conferência compara o preço por unidade, que é o valor dividido pela quantidade, com o preço típico do produto. A maioria das linhas fica sem conferência por falta de base, o que não é defeito. Cada marca é explicada na perspectiva Qualidade dos dados. Os rebanhos ficam sempre sem conferência, porque são contados em cabeças e não têm preço. Nesta base também aparece o pico isolado no tempo, um valor grande num único ano que faz a série do estado dar um salto.' },
    ],
  },
  ...
  mdic_comex: {
    ...
    terms: [
      ...
      { term: 'val_yearfx_* · val_real_*', cat: 'Coluna', tag: 'gold', short: 'O valor de origem do comércio é o FOB em dólares. val_yearfx_usd é o próprio valor da fonte, sem conversão, e as versões em reais e em euros usam o câmbio médio do ano. As colunas val_real_* trazem os valores a preços de hoje, para comparar anos diferentes. Em dólares o índice oferecido é o CPI dos EUA (val_real_cpi_usd), que não passa por câmbio nenhum, porque o valor já vem em dólares.' },
  ...
  un_comtrade: {
    ...
    terms: [
      ...
      { term: 'data_quality_flag', cat: 'Coluna', tag: 'qualidade', short: 'Marca que diz se o sistema conseguiu conferir a linha e o que encontrou. A conferência compara o preço por unidade, que é o valor dividido pela quantidade, com o preço típico do produto. A maioria das linhas fica sem conferência por falta de base, o que não é defeito. Cada marca é explicada na perspectiva Qualidade dos dados. Aqui a quantidade usada é o peso líquido, e o preço conferido é o valor em dólares por quilo. Quando o país não informa o peso, o que acontece sobretudo com madeira, a linha recebe a marca de peso ausente e o valor continua valendo.' },
    ],
  },
