  ...
  ibge_pevs: {
    ...
    dims: [
      ...
      { id: 'qualidade', tier: 'specific',  type: 'flags',
        ...
        hint: 'Marca de qualidade de cada linha. Recorta só a perspectiva Qualidade dos dados. As séries das outras perspectivas não mudam, e nenhuma linha sai do acervo.' },
    ],
  },
