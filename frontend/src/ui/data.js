...
window.QUALITY_FLAGS = [
  ...
  // "(válida)" is the Contrato de Dados category name (counted as real, kept by the default
  // filter), not a guarantee: the detector only asks that the price be within 100× of the
  // median, so the desc must say the margin is wide. v1.92.1 dropped that caveat while
